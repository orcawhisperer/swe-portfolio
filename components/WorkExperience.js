...
const WorkExperienceItem = ({ position }) => {
   ...
   return (
      <div
         ...
         <p className="text-gray-300 mb-2 shadow-text">{position.duration}</p>
         {!collapsed && (
            <ul className="list-disc pl-5 text-gray-300 shadow-text font-sans">
               {position.responsibilities.map((responsibility, index) => (
                  <li key={index}>{responsibility}</li>
               ))}
            </ul>
...
//                         className="w-32 h-auto" // Adjust width (w-32) as needed
//                      />
//                      <p className="text-xl text-white shadow-text">
//                         {experience.location}
//                      </p>
...
//                <div key={index} className="mb-12">
//                   <div className="flex items-center justify-between mb-4">
//                      <div className="w-32 h-auto bg-gradient-to-r from-gray-300 via-gray-400 to-gray-500 p-1 rounded">
//                         <img
//                            src={experience.logo}
//                            alt={`${experience.company} logo`}
//                            className="w-full h-auto rounded" // Adjust width (w-full) as needed
//                         />
//                      </div>
//                      <p className="text-xl text-white shadow-text">
//                         {experience.location}
